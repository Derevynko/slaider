...
function initSlider() {
  ...
  let sliderArrows = document.querySelector(".slider-navigation");
  let sliderImages = document.querySelector(".slider__images");
  let sliderDots = document.querySelector(".slider-navigation__dots");
  ...
  function initDots() {
    images.forEach((image, index) => {
      let dotsDiv = `<div class="slider-dots n${index} ${
        index === 0 ? "dots-active" : ""
      }" data-index="${index}"></div>`;
  ...
  function initTitles() {
    images.forEach((image, index) => {
      let titleDiv = `<div class="slid__name n${index} ${
  ...
  function moveSlaider(num) {
    ...
    repairCost = images[num].repairCost;
    document.querySelector(".title-active").classList.remove("title-active");
    document.querySelector(".slider__names").children[num].classList.add("title-active"); 
